...
vignette: >
  %\VignetteIndexEntry{Combining data from multiple sources}
...
Pass station IDs from different providers in one call. The router matches
each ID to its adapter automatically.
...
daily |>
  ...
  summarise(
    ...
    .by = c(station_id, provider_name, year)
  ) |>
